...
export function FrontendColorPaletteAdmin() {
  const { colorPalette, updateColorPalette, saveVersion, loadVersion, versions, refreshVersions, activeVersion } = useLocalDesignSystem();
  ...
  const colorDefinitions = [
    ...
    { key: 'neutral', label: 'Neutral', description: 'Neutral color' },
    ...
    <div className="space-y-6">
        ...
        <CardContent className="space-y-4">
          <div className="flex items-center gap-2">
            <Badge variant="outline">
              Active: {activeVersion?.version_name || 'Current Version'}
            </Badge>
            <Button
              variant="outline"
              size="sm"
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            Customize the design system color palette
          </CardDescription>
        </CardHeader>
